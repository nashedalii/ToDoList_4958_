...
<div class="bg-white">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div class="text-center">
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
          <a href="/login" class="rounded-md bg-teal-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-teal-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-400">Get started</a>
  ...
  <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <ul class="mt-12 flex justify-center gap-6 md:gap-8">
      ...
      <li>
        <a
          href="https://github.com/Dayatnur/Kelompok06-SiToDo-ProjectFINALPBW"
          rel="noreferrer"
          target="_blank"
          class="text-gray-700 transition hover:text-gray-700/75"
        >
